      ...
      >
        ...
        >
          ...
          <View className="px-6 space-y-4">
            ...
            >
              <TouchableOpacity className="bg-white/90 p-4 rounded-lg border border-gray-300 items-center shadow-sm">
                <Text className="text-gray-900 font-semibold text-base">
                  Continue with Google
                </Text>
              </TouchableOpacity>
              <TouchableOpacity className="bg-white/90 p-4 rounded-lg border border-gray-300 items-center shadow-sm mt-3">
                <Text className="text-gray-900 font-semibold text-base">
                  Continue with Apple
                </Text>
              </TouchableOpacity>
